...
// backgroundBlendMode: "screen, overlay, overlay, darken, normal"}},
    {text: "Cube", component: Cube, icon: icons.cards.cube, background: {background: "conic-gradient(from 30deg, rgb(53 53 53) 0%, rgb(15 15 15) 33.3%, rgb(38 38 38) 33.4%, rgb(28 28 28) 66.6%, rgb(54 54 54) 66.7%, rgb(33 33 33) 100%, rgb(0 0 0) 100%)"}},
    {text: "dSoc Website", component: dsocWebsite, icon: icons.cards.dsoc, background: {background: "linear-gradient(180deg, #A90051 0%, #1E0031 100%), linear-gradient(121.28deg, #340067 0%, #000000 38.54%), linear-gradient(180deg, #00FF19 0%, #000000 100%), linear-gradient(294.84deg, #FF0000 0%, #450000 100%), linear-gradient(121.28deg, #32003A 0%, #FF4040 100%), radial-gradient(50% 72.12% at 50% 50%, #EB00FF 0%, #110055 100%)",
backgroundBlendMode: "color-dodge, screen, overlay, exclusion, difference, normal"}},
    {text: "dSoc Designs", component: dsocDesigns, icon: icons.figma_white, background: {background: "linear-gradient(235deg, #FFFFFF 0%, #000F25 100%), linear-gradient(180deg, #6100FF 0%, #000000 100%), linear-gradient(235deg, #FFA3AC 0%, #FFA3AC 40%, #00043C calc(40% + 1px), #00043C 60%, #005D6C calc(60% + 1px), #005D6C 70%, #00C9B1 calc(70% + 1px), #00C9B1 100%), linear-gradient(125deg, #FFA3AC 0%, #FFA3AC 40%, #00043C calc(40% + 1px), #00043C 60%, #005D6C calc(60% + 1px), #005D6C 70%, #00C9B1 calc(70% + 1px), #00C9B1 100%)",
backgroundBlendMode: "soft-light, screen, darken, normal"}},
    {text: "Tutoring App", component: tutoringApp, icon: icons.cards.mylayr, background: {background: "radial-gradient(65% 100% at 50% 0%, #00FF94 0%, rgba(0, 255, 148, 0.25) 100%), linear-gradient(230deg, #000000 25%, #170059 100%), linear-gradient(215deg, #FFEBB9 10%, #19004E 80%), radial-gradient(100% 245% at 100% 100%, #FFFFFF 0%, #000353 100%), linear-gradient(125deg, #1400FF 0%, #3A0000 100%), linear-gradient(225deg, #00F0FF 30%, #000B6F 45%, #00EBFC 45%, #001676 65%, #00E1F6 65%, #001676 85%, #00ECFD 85%, #001676 100%), linear-gradient(135deg, #00F0FF 0%, #000B6F 15%, #00EBFC 15%, #001676 35%, #00E1F6 35%, #001676 55%, #00ECFD 55%, #001676 100%)",
backgroundBlendMode: "soft-light, screen, overlay, overlay, difference, overlay, normal"}},
    {text: "Photography", component: photography, icon: icons.camera, background: {background: "linear-gradient(45deg, rgb(0 0 0) 0%, rgb(0, 3, 32) 100%), radial-gradient(100% 225% at 100% 0%, rgb(255, 105, 40) 0%, rgb(145 65 0) 100%), linear-gradient(225deg, rgb(255, 122, 0) 0%, rgb(126 46 0) 100%), linear-gradient(135deg, rgb(205, 255, 235) 10%, rgb(205, 255, 235) 35%, rgb(0, 159, 157) 35%, rgb(0, 159, 157) 60%, rgb(7, 69, 111) 60%, rgb(7, 69, 111) 67%, rgb(15, 10, 60) 67%, rgb(15, 10, 60) 100%)",
